...
import com.jacobmorris.rccontroller.res.RCSocket;
...
public class rccontroller extends Activity {
    ...
    public ControlRegion FindControlRegion(float x){
	  ...
	  public class ClientThreadOld implements Runnable {
	  ...
	  class ClientThread extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... params) {
			while(connected){
				...
				//} catch (InterruptedException e) {
					// TODO Auto-generated catch block
					Toast.makeText(rccontroller.this, "Thread Interrupted", Toast.LENGTH_LONG).show();
					e.printStackTrace();
				} catch (Exception e) {
