...
parser.add_argument('-p', action='store', dest='PORT', help='The port to listen on')
parser.add_argument('-d', action='store', dest='DEVICE', help='The serial device to open')
parser.add_argument('-b', action='store', dest='BAUD', help='The baud rate of the serial device to open')
